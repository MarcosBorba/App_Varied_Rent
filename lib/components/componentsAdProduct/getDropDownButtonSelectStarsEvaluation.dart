...
class SelectStarsEvaluationProduct extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => SelectStarsEvaluationProductState(
        stars: stars,
        hintText: hintText,
...
class SelectStarsEvaluationProductState
    extends State<SelectStarsEvaluationProduct> {
  List<Widget> stars;
  final String hintText;
  final ItemScrollController controllerItemRefreshListView;
  double starSelected;
  ...
  SelectStarsEvaluationProductState({
    this.onChanged,
    this.controllerItemRefreshListView,
    this.starSelected,
    this.hintText,
