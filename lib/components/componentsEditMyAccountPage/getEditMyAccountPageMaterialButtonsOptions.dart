...
class EditMyAccountPageMaterialButtonsOptions extends StatelessWidget {
  ...
  const EditMyAccountPageMaterialButtonsOptions({
    Key key,
    this.buttonColor =
        AppColors.editMyAccountPageMaterialButtonsOptionsBackgroundColor,
    this.elevation,
    this.onPressed,
    this.borderRadius,
    this.borderColor =
        AppColors.editMyAccountPageMaterialButtonsOptionsBorderColor,
    this.borderWidth,
    this.icon,
    this.iconSize,
    this.subTitle,
