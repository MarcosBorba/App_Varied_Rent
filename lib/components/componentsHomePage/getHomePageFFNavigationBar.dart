...
class HomePageFFNavigationBar extends StatelessWidget {
  ...
  const HomePageFFNavigationBar({
    ...
    this.selectedItemBorderColor = AppColors.selectedItemBorderColorBottomNanigationBar,
    this.selectedItemBackgroundColor = AppColors.selectedItemBackgroundColorBottomNanigationBar,
    this.selectedItemIconColor = AppColors.selectedItemIconColorBottomNanigationBar,
    this.selectedItemLabelColor = AppColors.selectedItemLabelColorBottomNanigationBar,
    this.unselectedItemIconColor = AppColors.unselectedItemIconColorBottomNanigationBar,
    this.unselectedItemLabelColor = AppColors.unselectedItemLabelColorBottomNanigationBar,
    this.itemWidth,
    this.barHeight,
  }) : super(key: key);
  @override
