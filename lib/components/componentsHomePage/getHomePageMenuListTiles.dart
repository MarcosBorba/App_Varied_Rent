...
class HomePageMenuListTiles extends StatelessWidget {
  final Text title;
  ...
  const HomePageMenuListTiles({
    Key key,
    this.title,
    this.onTap,
    this.iconColor = AppColors.iconColorOptionDefaultOfModalBottomSheet,
    this.borderRightColor = AppColors.iconColorOptionBorderRightOfModalBottomSheet,
    this.icon,
  }) : super(key: key);
